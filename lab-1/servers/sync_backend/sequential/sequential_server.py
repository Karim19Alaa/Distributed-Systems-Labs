    ...
    try:
        ...
        if op == "fib":
            try:
                ...
                client_socket.sendall(b"Error calculating fibonacci")  # Send error back to the client
            ...
            try:
                ...
                client_socket.sendall(b"Error contacting database")  # Send error back to client
...
def run_server(host, port):
    ...
    try:
        while True:
            ...
            handle_client(client_socket)  # Handle client in the main thread (blocking)
